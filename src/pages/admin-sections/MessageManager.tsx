                ...
                {messages.length === 0 ? (
                    ...
                    messages.map((m, idx) => (
                        <motion.div
                            ...
                            className="bg-rose-50/50 p-6 rounded-3xl border border-rose-100 group hover:bg-rose-50 transition-colors"
                        >
                            ...
                            <p className="text-neutral-600 italic text-sm leading-relaxed">&ldquo;{m.message}&rdquo;</p>
                        </motion.div>
                    ))
                )}
            </div>
